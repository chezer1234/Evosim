  ...
  return (
    <main className="relative flex min-h-svh flex-col items-center justify-center gap-2 overflow-hidden bg-neutral-950 px-6 text-center text-neutral-100">
      ...
      <div className="relative z-10 flex max-w-lg flex-col items-center gap-2">
        <p className="text-xs tracking-[0.16em] text-neutral-500 uppercase">A procedural island generator</p>
        <h1 className="font-serif text-5xl font-semibold tracking-tight text-neutral-50 sm:text-6xl">Understory</h1>
        <p className="mt-2 mb-8 max-w-md text-neutral-400">
          Chart a new coastline every time. Tune how the land folds, then walk into a forest that&apos;s never been
          mapped before.
        </p>
